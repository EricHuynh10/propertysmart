...
function App() {
  ...
  const fetchLocationOptions = async (inputValue) => {
    try {
      let url = `http://localhost:8000/location-options`;
  ...
  const fetchTop10 = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/top10?state=${stateValue}&sortBy=${yieldValue}&propertyType=${propertyTypeValue}&remoteness=${remoteness}&page=${currentPage}`);
  ...
  const fetchTotalRecords = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/total-records?state=${stateValue}&sortBy=${yieldValue}&propertyType=${propertyTypeValue}&remoteness=${remoteness}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(`http://localhost:8000/suburb/${selectedOptionStringFormatted}`);
